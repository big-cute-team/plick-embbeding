...
| 05 | 모델별 실험 (2인 병렬: Gemini/OpenAI) | 트랙 B: KAN-182~186 (KAN-3 하위) | ▶ current | B: 4/4 · A: 0/3 (KAN-272~274, 본인 인수) |
...
- [ ] **T10** (KAN-273) Gemini 구조 개선 실험 — 분야·핵심 대상으로 먼저 나눠 묶기 적용
- [ ] **T11** (KAN-274) Gemini 최적 구성 선정 — `wiki/트랙A_Gemini_실험종합.md` + 모델 노트
