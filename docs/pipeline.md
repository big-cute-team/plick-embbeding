...
- **임계값 안정성 분석(2026-07-15)**: 상세요약 최고들 임계 상단(0.65~0.75) 재확인 —
  더 높은 지점 없음. large/1536 @0.65(0.8077)은 그 기준값에서만 반짝 높고 조금만
  벗어나면 뚝 떨어짐. large/768 상세요약 @0.60은 기준값이 좀 달라져도 점수가 계속
  높게 유지됨(0.60~0.66 ~0.78). T08 선정은 기준값이 조금 틀어져도 유지되는지도 함께
  봐야 함. (--no-note)
