...
- **임계값 안정성 분석(2026-07-15)**: 상세요약 최고들 임계 상단(0.65~0.75) 재확인 —
  숨은 최고 지점 없음. 최고점 large/1536 @0.65(0.8077)은 뾰족한 봉우리(조금만 벗어나면
  급락), large/768 상세요약 @0.60은 넓고 평평한 안정 구간(0.60~0.66 ~0.78). T08 선정은
  임계값이 조금 틀어져도 유지되는지도 함께 봐야 함. (--no-note)
