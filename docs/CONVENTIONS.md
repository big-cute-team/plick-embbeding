...
| peak / 최고점 / 봉우리 | 점수가 제일 높은 기준값 |
| 스파이크 / 칼날 / 뾰족한 최고점 | 그 기준값에서만 반짝 높고 조금만 벗어나면 뚝 떨어지는 점수 |
| 고원 / plateau / 평평한 구간 | 기준값이 좀 달라져도 계속 높게 유지되는 점수 |
...
**비유어를 새로 만들지 않는다.** 어려운 말을 또 다른 번역체·비유("뾰족한
최고점", "봉우리", "고원" 등)로 바꾸지 말고, **무슨 일이 벌어지는지 있는 그대로
풀어 쓴다**(예: "그 기준값에서만 반짝 높고 조금만 벗어나면 뚝 떨어진다"). 초등학생도
바로 이해할 문장인지 스스로 점검한다.
