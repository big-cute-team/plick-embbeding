...
- 이슈(묶음) 수 / 중복 묶음 수: **64** / **10**
- 정답과 얼마나 일치하나 (ARI): **0.8077** ([[정답과 얼마나 일치하나 (ARI)]])
- 묶음 정확도(기사 쌍): 맞게 묶은 비율 0.8734 · 찾아낸 비율 0.7582 · 종합 0.8118
...
- 산출물: `/Users/juns0720/project/Plick/plick-embbeding/results/20260715_150724`
- 모델: [[text-embedding-3]]
